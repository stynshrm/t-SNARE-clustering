...
AA3     = spl("TRP TYR PHE HIS HIH ARG LYS CYS CYP ASP GLU ILE LEU MET ASN PRO HYP GLN SER THR VAL ALA GLY"+dnares3+rnares3) #@#
AA1     = spl("  W   Y   F   H   H   R   K   C   Z   D   E   I   L   M   N   P   O   Q   S   T   V   A   G"+dnares1+rnares1) #@#
...
class CoarseGrained:
    ...
    mapping = {
        "ALA":  nsplit(bb + " CB"),
        "CYS":  nsplit(bb,"CB SG"),
        "CYP":  nsplit(bb,"CB SG", "C3 C4 C5","C6 C7 C8 C9","C10 C11 C12 C13", "C14 C15 C16 C17"),
    ...
    residue_bead_names = spl("BB SC1 SC2 SC3 SC4 SC5")
    ...
    names.update([(i,("BB","SC1","SC2","SC3","SC4", "SC5")) for i in AA3])
...
class martini21:
    def __init__(self):
        ...
        self.sidechains = {
            ...
            "CYP": [spl("Na C1 C1 C1 C1"), [(0.390,5000), (0.47, 1250), (0.47, 1250),  (0.47, 1250), (0.47, 1250)], [(100,25),(180,25),(180,25),(180,25)]],
...
def main(options):
    ...
    if options['-o']:
        ...
        top.write(
'''#include "./martini/martini_v2.1.itp"
